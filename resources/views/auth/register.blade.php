                    ...
                    <div class="payment-info col-sm-12  fom-shad mb30">
                        ...
                        <div class="form-group" id="cc-group">
                            ...
                            <input placeholder="Credit Card Number" class="form-control" required="required" data-stripe="number"
                                   ...
                                   data-parsley-class-handler="#cc-group" name="dr_cc_num" type="text" id="cc" value="{{old('cc','')}}">
                        </div>

                        <div class="form-group" id="ccv-group">
                            <label for="CVC">CVC (3 or 4 digit number):<span class="require-label">*</span></label>
                            <input placeholder="Credit Card CVC" class="form-control" required="required" data-stripe="cvc" data-parsley-type="number"
                                   ...
                                   data-parsley-class-handler="#ccv-group" name="dr_cvc" type="text" value="{{old('cvc','')}}">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group" id="exp-m-group">
                                    ...
                                    <select class="form-control" required="required" data-stripe="exp-month" id="expMonth" name="dr_expMonth">
                                        @for($i = 1; $i <= 12; $i++ )
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group" id="exp-y-group">
                                    ...
                                    <select class="form-control" required="required" data-stripe="exp-year" id="expYear" name="dr_expYear">
